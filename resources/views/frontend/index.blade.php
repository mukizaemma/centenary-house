...
<head>
    <meta charset="utf-8">
    <title>{{ $settings->company_name ?? config('app.name') }} | Centenary House</title>
    <meta name="description" content="{{ $settings->company_name ?? config('app.name') }} offers premium office and commercial spaces to let at Centenary House in Kigali, with flexible offices, retail units and modern business facilities.">
    <meta name="keywords" content="Centenary House, office space Kigali, offices to let Rwanda, commercial property Kigali, serviced offices, retail space Kigali, meeting rooms Kigali, business centre Rwanda">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon Start Here -->
    <link rel="icon" type="image/png" href="{{ ($settings->logo_path ?? null) ? asset($settings->logo_path) : asset('templates/frontend/img/favicon-homlisti.svg') }}">
    ...
    <!-- Scroll reveal helper for this Blade page -->
    <style>
        .reveal-on-scroll {
            opacity: 0;
...
<body class="sticky-header">
                            ...
                            <ul class="topbar-right">
                                <li class="social-icon">
                                    <label>Follow Us On:</label>
                                        ...
                                        <a target="_blank" href="https://www.linkedin.com/signup"><i class="fab fa-linkedin-in"></i></a>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <ul class="sub-menu">
                                                            ...
                                                            <li>
                                                                <a href="agent-reviews.html">Agent Reviews Page<i class="fas fa-user"></i></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-3">
    ...
    <!--=====================================-->
        ...
        <section class="main-banner-wrap1 main-banner-wrap5" data-bg-image="img/slider/slider4.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
        ...
        <section class="why-choose-wrap1">
            <div class="container">
                <div class="item-heading-center mb-20">
                    ...
                    <h2 class="section-title">Our Main Speciality</h2>
                    <div class="bg-title-wrap" style="display: block;">
                        <span class="background-title solid">Speciality</span>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="choose-box1 choose-box2 wow fadeInUp" data-wow-delay=".2s">
                            <div class="choose-shape1">
                                <a href="single-listing1.html"><img src="img/figure/shape3.svg" alt="shape" width="59" height="63"></a>
                            </div>
                            <h3 class="item-title"><a href="single-listing1.html">Buy a New Home</a></h3>
                            <p>when an unknown printer took galley and scrambled itmakepe spear survived not five
                                centuries</p>
                                <div class="choose-button">
                                    <a href="single-listing1.html" class="item-btn">Check Property<i class="fas fa-chevron-circle-right"></i></a>
                                </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="choose-box1  choose-box2 wow fadeInUp" data-wow-delay=".4s">
                            <div class="choose-shape1">
                                <a href="single-listing1.html"><img src="img/figure/shape4.svg" alt="shape" width="59" height="63"></a>
                            </div>
                            <h3 class="item-title"><a href="single-listing1.html">Sell a Home</a></h3>
                            <p>when an unknown printer took galley and scrambled itmakepe spear survived not five
                                centuries</p>
                                <div class="choose-button">
                                    <a href="single-listing1.html" class="item-btn">Check Property<i class="fas fa-chevron-circle-right"></i></a>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="choose-box1  choose-box2 wow fadeInUp" data-wow-delay=".6s">
                            <div class="choose-shape1 choose-shape2">
                                <a href="single-listing1.html"><img src="img/figure/shape3.svg" alt="shape" width="59" height="63"></a>
                            </div>
                            <h3 class="item-title"><a href="single-listing1.html">Rent a Home</a></h3>
                            <p>when an unknown printer took galley and scrambled itmakepe spear survived not five
                                centuries</p>
                                <div class="choose-button">
                                    <a href="single-listing1.html" class="item-btn">Check Property<i class="fas fa-chevron-circle-right"></i></a>
                    ...
                    <div class="col-lg-5">
                        <div class="about-box5 wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <div class="about-shape">
                                <div class="choose-shape1">
                                    <a href="single-listing1.html"><img src="img/figure/shape7.svg" alt="shape" width="38" height="48"></a>
                                </div>
                                <div class="item-content">
                                    <h3 class="item-title">The Perfect Residency</h3>
                            ...
                            <div class="about-shape">
                                <div class="choose-shape1">
                                    <a href="single-listing1.html"><img src="img/figure/shape8.svg" alt="shape" width="38" height="48"></a>
                                </div>
                                <div class="item-content">
                                    <h3 class="item-title">Trusted By Thousands</h3>
                                    <p>Lorem ipsum dolorsit amet consectetur 
                                        eiusmod tempor incididunt.
                                    </p>
                                </div>
                            ...
                            <div class="about-shape">
                                <div class="choose-shape1">
                                    <a href="single-listing1.html"><img src="img/figure/shape9.svg" alt="shape" width="38" height="48"></a>
                                </div>
                                <div class="item-content">
                                    <h3 class="item-title">Total Payment Transparency</h3>
                                    <p>Lorem ipsum dolorsit amet consectetur 
                                        eiusmod tempor incididunt.
                                    </p>
                                </div>
                    ...
                    <div class="offset-lg-1 col-lg-6">
                        <div class="about-box8">
                            <div class="about-img-style-1">
                                <img src="img/blog/about10.jpg" alt="blog" width="364" height="577">
                                <div class="shape-img1 fa-spin">
                                    <img src="img/figure/shape6.svg" alt="shape" width="156" height="156">
                                </div>
                            </div>
                            <div class="about-img-style-2">
                                <img src="img/blog/about11.jpg" alt="blog" width="344" height="391">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="about-img-style-6">
                                            <img src="img/blog/about12.jpg" alt="blog" width="345" height="231">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-6 col-sm-7">
                        <div class="item-heading-left">
                            ...
                            <h2 class="section-title">Propertiey For Rent</h2>
                            <div class="bg-title-wrap" style="display: block;">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-5">
                        <div class="heading-button">
                            <a href="single-listing1.html" class="heading-btn">See All Properties</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="property-box6 wow animated fadeInUp" data-wow-delay=".6s">
                                    <div class="item-img">
                                        <a href="single-listing1.html"><img src="img/blog/blog29.jpg" alt="blog" width="385" height="259"></a>
                                    ...
                                    <div class="item-content">
                                        <div class="verified-area">
                                            <h3 class="item-title"><a href="single-listing1.html">Brand New Shopping Mall for Sale</a></h3>
                                        </div>
                                        <div class="location-area"><i class="flaticon-maps-and-flags"></i>Downey, California</div>
                                        <div class="item-price">$15,000/<span>mo</span></div>
                                        <div class="item-categoery3">
                                            <ul>
                                                <li><i class="flaticon-bed"></i><span>Beds: 03</span></li>
                                                <li><i class="flaticon-shower"></i><span>Baths: 02</span></li>
                            ...
                            <div class="swiper-slide">
                                <div class="property-box6 wow animated fadeInUp" data-wow-delay=".6s">
                                    <div class="item-img">
                                        <a href="single-listing1.html"><img src="img/blog/blog30.jpg" alt="blog" width="385" height="259"></a>
                                        <div class="categoery-style-3">
                                            <div class="item-category-box1">
                                    ...
                                    <div class="item-content">
                                        <div class="verified-area">
                                            <h3 class="item-title"><a href="single-listing1.html">Triple Story House for Rent</a></h3>
                                        </div>
                                        <div class="location-area"><i class="flaticon-maps-and-flags"></i>Downey, California</div>
                                        <div class="item-price">$28,000/<span>mo</span></div>
                                        <div class="item-categoery3">
                                            <ul>
                                                <li><i class="flaticon-bed"></i><span>Beds: 03</span></li>
                                                <li><i class="flaticon-shower"></i><span>Baths: 02</span></li>
                            ...
                            <div class="swiper-slide">
                                <div class="property-box6 wow animated fadeInUp" data-wow-delay=".6s">
                                    <div class="item-img">
                                        <a href="single-listing1.html"><img src="img/blog/blog31.jpg" alt="blog" width="385" height="259"></a>
                                        <div class="categoery-style-3">
                                            <div class="item-category-box1">
                                                <div class="item-category">For Rent</div>
                                            </div>
                                    ...
                                    <div class="item-content">
                                        <div class="verified-area">
                                            <h3 class="item-title"><a href="single-listing1.html">Northwest Office Space</a></h3>
                                        </div>
                                        <div class="location-area"><i class="flaticon-maps-and-flags"></i>Downey, California</div>
                                            <div class="item-price">$12,000/<span>mo</span></div>
                                        <div class="item-categoery3">
                                            <ul>
                                                <li><i class="flaticon-bed"></i><span>Beds: 03</span></li>
                                                <li><i class="flaticon-shower"></i><span>Baths: 02</span></li>
                            ...
                            <div class="swiper-slide">
                                <div class="property-box6 wow animated fadeInUp" data-wow-delay=".6s">
                                    <div class="item-img">
                                        <a href="single-listing1.html"><img src="img/blog/blog32.jpg" alt="blog" width="385" height="259"></a>
                                        <div class="categoery-style-3">
                                            <div class="item-category-box1">
                                                <div class="item-category">For Sell</div>
                                            </div>
                                    ...
                                    <div class="item-content">
                                        ...
                                        <div class="location-area"><i class="flaticon-maps-and-flags"></i>Downey, California</div>
                                        <div class="item-price">$40,000/<span>mo</span></div>
                                        <div class="item-categoery3">
                                            <ul>
                                                <li><i class="flaticon-bed"></i><span>Beds: 03</span></li>
                                                <li><i class="flaticon-shower"></i><span>Baths: 02</span></li>
        ...
        <section class="property-wrap-6">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-9 mx-auto">
                        <div class="property-box2 property-box5 wow animated fadeInUp" data-wow-delay=".6s">
                            <div class="item-img">
                                <a href="single-listing1.html"><img src="img/blog/blog29.jpg" alt="blog" width="220" height="170"></a>
                                <div class="react-icon">
                                    <ul>
                                        <li>
                            ...
                            <div class="item-content item-content-property">
                                ...
                                <div class="item-price">$15,000<i>/</i><span>mo</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-9 mx-auto">
                        <div class="property-box2 property-box5 wow animated fadeInUp" data-wow-delay=".6s">
                            <div class="item-img">
                                <a href="single-listing1.html"><img src="img/blog/blog30.jpg" alt="blog" width="220" height="170"></a>
                                <div class="react-icon">
                                    <ul>
                                        <li>
                                            <a href="favourite.html" data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <div class="item-content item-content-property">
                                ...
                                <div class="item-price">$35,000<i>/</i><span>yr</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-9 mx-auto">
                        <div class="property-box2 property-box5 wow animated fadeInUp" data-wow-delay=".6s">
                            <div class="item-img">
                                <a href="single-listing1.html"><img src="img/blog/blog31.jpg" alt="blog" width="220" height="170"></a>
                                <div class="react-icon">
                                    <ul>
                                        <li>
                                            <a href="favourite.html" data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <div class="item-content item-content-property">
                                <div class="verified-area">
                                    <h3 class="item-title"><a href="single-listing1.html">Brand New Shopping Mall Sale</a></h3>
                                </div>
                                <div class="location-area"><i class="flaticon-maps-and-flags"></i>Downey, California</div>
                                <div class="item-categoery5">
                                    <ul>
                    ...
                    <div class="col-xl-6 col-lg-9 mx-auto">
                        <div class="property-box2 property-box5 wow animated fadeInUp" data-wow-delay=".6s">
                            <div class="item-img">
                                <a href="single-listing1.html"><img src="img/blog/blog32.jpg" alt="blog" width="220" height="170"></a>
                                <div class="react-icon">
                                    <ul>
                                        <li>
                                            <a href="favourite.html" data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <div class="item-content item-content-property">
                                <div class="verified-area">
                                    <h3 class="item-title"><a href="single-listing1.html">Affordable Green Villa House</a></h3>
                                </div>
                                <div class="location-area"><i class="flaticon-maps-and-flags"></i>Downey, California</div>
                                <div class="item-categoery5">
                                    <ul>
                                ...
                                <div class="item-price">$17,000<i>/</i><span>mo</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-9 mx-auto">
                        <div class="property-box2 property-box5 wow animated fadeInUp" data-wow-delay=".6s">
                            <div class="item-img">
                                <a href="single-listing1.html"><img src="img/blog/blog33.jpg" alt="blog" width="220" height="170"></a>
                                <div class="react-icon">
                                    <ul>
                                        <li>
                                            <a href="favourite.html" data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <div class="col-xl-6 col-lg-9 mx-auto">
                        <div class="property-box2 property-box5 wow animated fadeInUp" data-wow-delay=".6s">
                            <div class="item-img">
                                <a href="single-listing1.html"><img src="img/blog/blog34.jpg" alt="blog" width="220" height="170"></a>
                                <div class="react-icon">
                                    <ul>
                                        <li>
                                            <a href="favourite.html" data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <div class="item-content item-content-property">
                                <div class="verified-area">
                                    <h3 class="item-title"><a href="single-listing1.html">Sky Pool Villa House</a></h3>
                                </div>
                                <div class="location-area"><i class="flaticon-maps-and-flags"></i>Downey, California</div>
                                <div class="item-categoery5">
                                    <ul>
                ...
                <div class="property-button">
                    <a href="single-listing1.html" class="item-btn">View All Properties</a>
                </div>
            </div>
        </section>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="location-box3 wow zoomIn" data-wow-delay=".2s">
                                <div class="item-img">
                                    <a href="single-listing1.html"><img src="img/blog/location10.jpg" alt="location" width="520" height="440"></a>
                                </div>
                                <div class="item-content">
                                    <div class="content-body">
                                        <div class="item-category">02 properties</div>
                                        <div class="item-title">
                                            <h3><a href="single-listing2.html">Kansas</a></h3>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="location-box3 wow zoomIn" data-wow-delay=".2s">
                                <div class="item-img">
                                    <a href="single-listing1.html"><img src="img/blog/location11.jpg" alt="location" width="520" height="440"></a>
                                </div>
                                <div class="item-content">
                                    <div class="content-body">
                                        <div class="item-category">05 properties</div>
                                        <div class="item-title">
                                            <h3><a href="single-listing2.html">Albania</a></h3>
                                        </div>
                                    </div>
                                    <div class="location-button">
                                        <a href="single-listing3.html" class="location-btn"><i class="fas fa-arrow-right"></i></a>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="location-box3 wow zoomIn" data-wow-delay=".2s">
                        <div class="item-img">
                            <a href="single-listing1.html"><img src="img/blog/location12.jpg" alt="location" width="690" height="280"></a>
                        </div>
                        <div class="item-content">
                            <div class="content-body">
                                <div class="item-category">03 properties</div>
                                <div class="item-title">
                ...
                <div class="col-lg-6">
                    <div class="location-box3 wow zoomIn" data-wow-delay=".3s">
                        <div class="item-img">
                            <a href="single-listing1.html"><img src="img/blog/location13.jpg" alt="location" width="690" height="280"></a>
                        </div>
                        <div class="item-content">
                            <div class="content-body">
                                <div class="item-category">04 properties</div>
                                <div class="item-title">
                                    <h3><a href="single-listing2.html">San Francisco</a></h3>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="location-box3 wow zoomIn" data-wow-delay=".2s">
                                <div class="item-img">
                                    <a href="single-listing1.html"><img src="img/blog/location14.jpg" alt="location" width="520" height="440"></a>
                                </div>
                                <div class="item-content">
                                    <div class="content-body">
                                        <div class="item-category">02 properties</div>
                                        <div class="item-title">
                                            <h3><a href="single-listing2.html">New York</a></h3>
                                        </div>
                                    </div>
                                    <div class="location-button">
                                        <a href="single-listing3.html" class="location-btn"><i class="fas fa-arrow-right"></i></a>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="location-box3 wow zoomIn" data-wow-delay=".2s">
                                <div class="item-img">
                                    <a href="single-listing1.html"><img src="img/blog/location15.jpg" alt="location" width="520" height="440"></a>
                                </div>
                                <div class="item-content">
                                    <div class="content-body">
                                        <div class="item-category">07 properties</div>
                                        <div class="item-title">
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-box1 team-box2 wow fadeInUp" data-wow-delay=".6s">
                            <div class="item-img">
                                <a href="agent-lists1.html">
                                    <img src="img/team/team21.png" alt="team" height="240" width="240">
                                </a>
                                ...
                                <div class="category-box">
                                    <div class="item-category"><a href="single-agent1.html">08 Listings</a></div>
                                </div>
                            </div>
                            <div class="item-content">
                                <div class="item-title">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-box1 team-box2 wow fadeInUp" data-wow-delay=".4s">
                            <div class="item-img">
                                <a href="agent-lists1.html">
                                    <img src="img/team/team22.png" alt="team" height="240" width="240">
                                </a>
                                <ul class="team-social-1">
                                    <li class="social-item">
                                        <a href="https://radiustheme.com/" target="_blank" class="social-hover-icon social-link"><i
                                ...
                                <div class="category-box">
                                    <div class="item-category"><a href="single-agent1.html">05 Listings</a></div>
                                </div>
                            </div>
                            <div class="item-content">
                                <div class="item-title">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-box1 team-box2 wow fadeInUp" data-wow-delay=".2s">
                            <div class="item-img">
                                <a href="agent-lists1.html">
                                    <img src="img/team/team23.png" alt="team" height="240" width="240">
                                </a>
                                <ul class="team-social-1">
                                    <li class="social-item">
                                        <a href="https://radiustheme.com/" target="_blank" class="social-hover-icon social-link"><i
                                ...
                                <div class="category-box">
                                    <div class="item-category"><a href="single-agent1.html">11 Listings</a></div>
                                </div>
                            </div>
                            <div class="item-content">
                                <div class="item-title">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="team-box1 team-box2 wow fadeInUp" data-wow-delay=".2s">
                            <div class="item-img">
                                <a href="agent-lists1.html">
                                    <img src="img/team/team24.png" alt="team" height="240" width="240">
                                </a>
                                <ul class="team-social-1">
                                    <li class="social-item">
                                        <a href="https://radiustheme.com/" target="_blank" class="social-hover-icon social-link"><i
                                ...
                                <div class="category-box">
                                    <div class="item-category"><a href="single-agent1.html">06 Listings</a></div>
                                </div>
                            </div>
                            <div class="item-content">
                                <div class="item-title">
                                    <h3><a href="agent-lists1.html">Andren Willium</a></h3>
                                    <h4 class="item-subtitle"><a href="agency-lists1.html">Sarah Boysen</a></h4>
                                </div>
                                <div class="item-contact">
                                    <div class="item-icon"><i class="fas fa-phone-alt"></i></div>
                                    <div class="item-phn-no">Call: +123 699 7700</div>
                ...
                <div class="row align-items-center">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="single-test">
                                            ...
                                            <p>“ Engage with our professional realestaeyeagents sell buy
                                                or rent your home aeweGet emails directly areain falls
                                                box andery manage the lead ithe ”</p>
                                            <ul class="item-rating">
                                                <li><i class="fas fa-star"></i></li>
                                                <li><i class="fas fa-star"></i></li>
                                                <li><i class="fas fa-star"></i></li>
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="testimonial-img-2 wow fadeInRight" data-wow-delay=".2s">
                            <img src="img/blog/testimonial2.jpg" alt="blog" width="690" height="730">
                        </div>
                    </div>
    ...
    <!--=====================================-->
        ...
        <section class="newsletter-wrap2 wow fadeInUp" data-wow-delay=".3s">
            <div class="container">
                <div class="newsletter-box2">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="newsletter-layout2">
                                <div class="item-heading">
                                    <h2 class="item-title">Looking for a Dream Home </h2>
                                ...
                                <div class="newsletter-button">
                                    <a href="single-listing1.html" class="item-btn">Explore Our Properties</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- Scroll reveal for this Blade homepage -->
    <script>
        (function () {
            let observer;
