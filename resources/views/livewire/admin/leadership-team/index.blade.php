...
<div>
    <div class="bg-light rounded p-4">
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-3">
            <h4 class="mb-2">Leadership Team</h4>
                ...
                <tbody>
                    @forelse($members as $m)
                        <tr>
                            <td>
                                @if($m->profile_image)
                                    <img src="{{ asset($m->profile_image) }}" alt="" class="rounded-circle border" style="height: 44px; width: 44px; object-fit: cover;">
                                @else
                            ...
                            <td class="text-end">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-danger" wire:click="delete({{ $m->id }})" onclick="return confirm('Remove this member?')">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center text-muted py-4">No leadership team members found.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $editingId ? 'Edit Leadership Team Member' : 'New Leadership Team Member' }}</h5>
                        ...
                        <form wire:submit.prevent="save" id="leadership-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" wire:model.defer="position" placeholder="e.g. CEO, Medical Director">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" form="leadership-form">
